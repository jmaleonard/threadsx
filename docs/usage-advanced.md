...
```js
// master.js
import { spawn, Transfer, Worker } from "threadsx"
...
import { expose, Transfer } from "threadsx/worker"
...
```js
import { expose, Observable, Transfer } from "threadsx/worker"
...
```typescript
import { SerializerImplementation } from "threadsx"
...
```typescript
import { registerSerializer } from "threadsx"
// also exported from the worker sub-module:
// import { registerSerializer } from "threadsx/worker"
...
// threadsx will first try to use AnotherSerializer, will fall back to SomeSerializer,
